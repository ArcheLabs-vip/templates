...
- **Editorial** — composição sofisticada, bastante espaço visual e forte presença de tipografia e imagens.
- **Signature** — experiência premium, identidade marcante e maior nível de personalização.
- **Vanguard** — direção contemporânea, composições experimentais e interações mais avançadas.
