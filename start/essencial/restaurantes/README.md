# Start — Coleção Essencial — Restaurantes

Aplicação da Coleção Essencial, do plano Start, para restaurantes, cafés, bares e negócios gastronômicos. Derivada do `essencial-core`.
