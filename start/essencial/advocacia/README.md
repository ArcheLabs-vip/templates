# Start — Coleção Essencial — Advocacia

Aplicação da Coleção Essencial, do plano Start, para escritórios de advocacia e profissionais autônomos. Derivada do `essencial-core`.
