# Start — Coleção Essencial — Psicologia

Aplicação da Coleção Essencial para psicólogos e clínicas de psicologia. Prioriza abordagens terapêuticas, públicos atendidos, modalidades de consulta, acolhimento e contato ético.

Derivação técnica: `../essencial-core`, com arquitetura de componentes alinhada ao padrão de `../estetica`.
